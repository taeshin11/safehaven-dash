...
export const metadata: Metadata = {
  title: '404 — Page Not Found | SafeHaven Dash',
  description: 'The page you are looking for does not exist. Return to SafeHaven Dash to track gold, safe-haven currencies, and the Fear Gauge.',
